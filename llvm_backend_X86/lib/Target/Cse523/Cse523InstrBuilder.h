//===-- Cse523InstrBuilder.h - Functions to aid building Cse523 insts -*- C++ -*-===//
//
...
// MachineInstrBuilder.h file to handle Cse523'isms in a clean way.
//
// The BuildMem function may be used with the BuildMI function to add entire
// memory references in a single, typed, function call.  Cse523 memory references
...
#ifndef Cse523INSTRBUILDER_H
#define Cse523INSTRBUILDER_H
...
namespace llvm {
    ...
    /// Cse523AddressMode - This struct holds a generalized full Cse523 address mode.
    /// The base register can be a frame index, which will eventually be replaced
    /// with BP or SP and Disp being offsetted accordingly.  The displacement may
    /// also include the offset of a global value.
    struct Cse523AddressMode {
        enum {
            RegBase,
            FrameIndexBase
        } BaseType;
        ...
        void getFullAddress(SmallVectorImpl<MachineOperand> &MO) {
            ...
            if (BaseType == Cse523AddressMode::RegBase)
                MO.push_back(MachineOperand::CreateReg(Base.Reg, false, false,
                            false, false, false, 0, false));
            else {
                assert(BaseType == Cse523AddressMode::FrameIndexBase);
    ...
    static inline const MachineInstrBuilder &
        addFullAddress(const MachineInstrBuilder &MIB,
            ...
            if (AM.BaseType == Cse523AddressMode::RegBase)
                ...
                assert(AM.BaseType == Cse523AddressMode::FrameIndexBase);
    ...
    /// either machine code emission or assembly output. In PIC mode on Cse523-32,
