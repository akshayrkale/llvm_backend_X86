//===-- Cse523AsmPrinter.cpp - Convert Cse523 LLVM code to AT&T assembly --------===//
//
...
// of machine-dependent LLVM code to Cse523 machine code.
//
//===----------------------------------------------------------------------===//
...
///
bool Cse523AsmPrinter::runOnMachineFunction(MachineFunction &MF) {
...
static void printOperand(Cse523AsmPrinter &P, const MachineInstr *MI,
...
static void printPCRelImm(Cse523AsmPrinter &P, const MachineInstr *MI,
        unsigned OpNo, raw_ostream &O) {
    ...
    switch (MO.getType()) {
        ...
        case MachineOperand::MO_Register: {
                                              ...
                                              if (Modifier && strncmp(Modifier, "subreg", strlen("subreg")) == 0) {
                                                  ...
                                                  Reg = getCse523SubSuperRegister(Reg, VT);
                                              }
                                              O << Cse523ATTInstPrinter::getRegisterName(Reg);
                                              return;
                                          }
...
static void printLeaMemReference(Cse523AsmPrinter &P, const MachineInstr *MI,
    ...
    if (HasParenPart) {
        // TODO: Replaced
        assert(IndexReg.getReg() != Cse523::RSP &&
                "Cse523 doesn't allow scaling by RSP");
...
static void printMemReference(Cse523AsmPrinter &P, const MachineInstr *MI,
        unsigned Op, raw_ostream &O,
        const char *Modifier = NULL) {
...
static void printIntelMemReference(Cse523AsmPrinter &P, const MachineInstr *MI,
        unsigned Op, raw_ostream &O,
        const char *Modifier = NULL,
...
static bool printAsmMRegister(Cse523AsmPrinter &P, const MachineOperand &MO,
        char Mode, raw_ostream &O) {
    unsigned Reg = MO.getReg();
    switch (Mode) {
        default: return true;  // Unknown mode.
        case 'b': // Print QImode register
                 Reg = getCse523SubSuperRegister(Reg, MVT::i8);
                 break;
        case 'h': // Print QImode high register
                 Reg = getCse523SubSuperRegister(Reg, MVT::i8, true);
                 break;
        case 'w': // Print HImode register
                 Reg = getCse523SubSuperRegister(Reg, MVT::i16);
                 break;
        case 'k': // Print SImode register
                 Reg = getCse523SubSuperRegister(Reg, MVT::i32);
                 break;
        case 'q': // Print DImode register
                 // FIXME: gcc will actually print e instead of r for 32-bit.
                 Reg = getCse523SubSuperRegister(Reg, MVT::i64);
                 break;
    }
...
///
bool Cse523AsmPrinter::PrintAsmOperand(const MachineInstr *MI, unsigned OpNo,
        unsigned AsmVariant,
...
bool Cse523AsmPrinter::PrintAsmMemoryOperand(const MachineInstr *MI,
...
extern "C" void LLVMInitializeCse523AsmPrinter() {
    RegisterAsmPrinter<Cse523AsmPrinter> X(TheCse523Target);
}
