//===-- Cse523TargetObjectFile.cpp - Cse523 Object Info -------------------------===//
//
...
const MCExpr *Cse523_64MachoTargetObjectFile::getTTypeGlobalReference(
    const GlobalValue *GV, unsigned Encoding, Mangler &Mang,
    const TargetMachine &TM, MachineModuleInfo *MMI,
    MCStreamer &Streamer) const {

  // On Darwin/Cse523-64, we can reference dwarf symbols with foo@GOTPCREL+4, which
...
MCSymbol *Cse523_64MachoTargetObjectFile::getCFIPersonalitySymbol(
...
void
Cse523LinuxTargetObjectFile::Initialize(MCContext &Ctx, const TargetMachine &TM) {
  TargetLoweringObjectFileELF::Initialize(Ctx, TM);
  InitializeELF(TM.Options.UseInitArray);
}

const MCExpr *
Cse523LinuxTargetObjectFile::getDebugThreadLocalSymbol(
    const MCSymbol *Sym) const {
  return MCSymbolRefExpr::Create(Sym, MCSymbolRefExpr::VK_DTPOFF, getContext());
}

const MCExpr *Cse523WindowsTargetObjectFile::getExecutableRelativeSymbol(
