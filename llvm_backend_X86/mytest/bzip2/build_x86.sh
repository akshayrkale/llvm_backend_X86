...
#TOOLS_PATH=~/llvm/llvm/build_x86/Debug+Asserts/bin/ 
TOOLS_PATH=../../build_x86/Debug+Asserts/bin
for c in *.c; do
     if [ -f $c.o ]
     then
         continue
    ...
    $TOOLS_PATH/clang -Wno-main-return-type -emit-llvm -O3 -S -c -o $c.bc -msoft-float -nobuiltininc -isystem $LIBC_PATH/include $c -isystem .
