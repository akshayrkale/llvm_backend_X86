...
for c in *.c; do
    ...
    $TOOLS_PATH/clang -Wno-main-return-type -emit-llvm -g3  -S -c -o $c.bc -nobuiltininc -isystem $LIBC_PATH/include $c -isystem .
    echo "[Running] llc $c.bc"
    $TOOLS_PATH/llc -soft-float -march=cse523  $c.bc -o $c.S
