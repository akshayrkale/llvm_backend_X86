...
TOOLS_PATH=~/templlvm/llvm_backend_X86/build_523/Debug+Asserts/bin
for c in *.c; do
     if [ -f $c.o ]
     then
         continue
    ...
    $TOOLS_PATH/clang -Wno-main-return-type -emit-llvm -DENABLE_SCORE -DENABLE_PREVIEW -DENABLE_HIGH_SCORE -O3 -S -c -o $c.bc -nobuiltininc -isystem $LIBC_PATH/include $c -isystem .  -isystem */ -DSPEC_CPU
